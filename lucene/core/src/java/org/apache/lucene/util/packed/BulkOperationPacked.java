...
class BulkOperationPacked extends BulkOperation {// block的概念：假如每个数据长度为6，用long存储，一个long为64，那么存储3*2*32=192个字节，可以恰好是64的整数倍，存储不浪费一点空间，192个字节需要3个long来组成。
  ...
  @Override
  public void encode(//blocks 真正存放byte的地方
