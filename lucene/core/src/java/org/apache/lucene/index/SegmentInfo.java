...
public final class SegmentInfo {
  ...
  public void setCodec(Codec codec) {// 会在Lucene86SegmentInfoFormat.read()里面初始化构建
  ...
  private Set<String> setFiles; //本次flush产生的16个索引文件。当复合文件合并后，这里会被代替成2个复合文件（确定不会包含.liv文件）
