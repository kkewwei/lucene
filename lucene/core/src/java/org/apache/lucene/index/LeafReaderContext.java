...
/** {@link IndexReaderContext} for {@link LeafReader} instances. */  //即用来描述某一个段的信息，并且通过它能获得一个 LeafCollector 对象
public final class LeafReaderContext extends IndexReaderContext {
  ...
  public LeafReader reader() {
    return reader; // SegmentReader，查询时可以是 ExitableLeafReader（里面实际其作用的是 ElasticsearchLeafReader， 最里面是SegmentReader），refresh时候可以是ElasticsearchLeafReader
  }
