...
public final class Lucene103PostingsReader extends PostingsReaderBase {
  ...
  final class BlockPostingsEnum extends ImpactsEnum {
    ...
    // 参考 Lucene103PostingsWriter.writeLevel1SkipData
    ...
    private void doMoveToNextLevel0Block() throws IOException {
      ...
      if (docCountLeft >= BLOCK_SIZE) {// 剩余大于128个doc
        docIn.readVLong(); // level0NumBytes。 // level0NumBytes    实际是numSkipBytes
    ...
    private final Impacts impacts =
        new Impacts() {
          ...
          private FreqAndNormBuffer readImpacts(
            ...
            Lucene103PostingsReader.readImpacts(scratch, impactBuffer);//去解析频率
            return impactBuffer;
          }
        };
